...
[**Report a vulnerability**](https://github.com/hassio-addons/app-calibre-web/security/advisories/new)
...
- Issues in Calibre-Web itself; please report those directly to the
  [Calibre-Web project](https://github.com/janeczku/calibre-web/security/policy).
...
This security policy covers the Calibre-Web app in this repository: the app
